import{a3 as C,S as U,i as N,s as E,e as k,c as w,a as v,d as c,b as h,a4 as I,f as y,D as f,t as $,k as S,g as J,n as M,a5 as A,h as P,F as V,a6 as D,j as H,I as W,a7 as F,m as L,o as G,a8 as R,x as Y,u as z,v as B,A as O,H as K}from"../chunks/vendor-76a7eba6.js";import"../chunks/markmap-22b6b98e.js";import{F as Q}from"../chunks/footer-138af798.js";var X=`<p>This project is heavily inspired by <a href="https://github.com/dundalek/markmap">dundalek&#39;s markmap</a>.</p>
...
`;function j(m,r,o){const t=m.slice();return t[5]=r[o],t}function x(m){let r,o,t=m[1],s=[];for(let e=0;e<t.length;e+=1)s[e]=q(j(m,t,e));return{c(){r=k("aside"),o=k("ul");for(let e=0;e<s.length;e+=1)s[e].c();this.h()},l(e){r=w(e,"ASIDE",{class:!0,style:!0});var i=v(r);o=w(i,"UL",{class:!0});var n=v(o);for(let a=0;a<s.length;a+=1)s[a].l(n);n.forEach(c),i.forEach(c),this.h()},h(){h(o,"class","toc"),h(r,"class","bg-gray-100 p-4 hidden lg:block overflow-auto"),I(r,"width","240px")},m(e,i){y(e,r,i),f(r,o);for(let n=0;n<s.length;n+=1)s[n].m(o,null)},p(e,i){if(i&6){t=e[1];let n;for(n=0;n<t.length;n+=1){const a=j(e,t,n);s[n]?s[n].p(a,i):(s[n]=q(a),s[n].c(),s[n].m(o,null))}for(;n<s.length;n+=1)s[n].d(1);s.length=t.length}},d(e){e&&c(r),V(s,e)}}}function q(m){let r,o,t=m[5].title+"",s,e,i,n;return{c(){r=k("li"),o=k("a"),s=$(t),i=S(),this.h()},l(a){r=w(a,"LI",{class:!0});var l=v(r);o=w(l,"A",{href:!0});var u=v(o);s=J(u,t),u.forEach(c),i=M(l),l.forEach(c),this.h()},h(){h(o,"href",e="#"+m[5].id),A(o,"active",m[5]===m[2]),h(r,"class",n="toc-item toc-"+m[5].depth)},m(a,l){y(a,r,l),f(r,o),f(o,s),f(r,i)},p(a,l){l&2&&t!==(t=a[5].title+"")&&P(s,t),l&2&&e!==(e="#"+a[5].id)&&h(o,"href",e),l&6&&A(o,"active",a[5]===a[2]),l&2&&n!==(n="toc-item toc-"+a[5].depth)&&h(r,"class",n)},d(a){a&&c(r)}}}function Z(m){let r,o,t,s,e,i,n,a,l,u,T,p=m[1]&&x(m);return a=new Q({}),{c(){r=k("meta"),o=S(),t=k("main"),p&&p.c(),s=S(),e=k("div"),i=new D,n=S(),H(a.$$.fragment),this.h()},l(d){const g=W('[data-svelte="svelte-1m2buf9"]',document.head);r=w(g,"META",{name:!0,content:!0}),g.forEach(c),o=M(d),t=w(d,"MAIN",{class:!0});var b=v(t);p&&p.l(b),s=M(b),e=w(b,"DIV",{class:!0});var _=v(e);i=F(_),n=M(_),L(a.$$.fragment,_),_.forEach(c),b.forEach(c),this.h()},h(){document.title="markmap docs",h(r,"name","Description"),h(r,"content","The documentation of markmap packages."),i.a=n,h(e,"class","markdown flex-1 min-w-0 p-4 lg:pr-12 overflow-auto"),h(t,"class","flex md:fs")},m(d,g){f(document.head,r),y(d,o,g),y(d,t,g),p&&p.m(t,null),f(t,s),f(t,e),i.m(X,e),f(e,n),G(a,e,null),m[4](e),l=!0,u||(T=R(e,"scroll",m[3]),u=!0)},p(d,[g]){d[1]?p?p.p(d,g):(p=x(d),p.c(),p.m(t,s)):p&&(p.d(1),p=null)},i(d){l||(Y(a.$$.fragment,d),l=!0)},o(d){z(a.$$.fragment,d),l=!1},d(d){c(r),d&&c(o),d&&c(t),p&&p.d(),B(a),m[4](null),u=!1,T()}}}const ee=C([{type:"script",data:{src:"https://cdn.jsdelivr.net/npm/prismjs@1/components/prism-core.min.js"}},{type:"script",data:{src:"https://cdn.jsdelivr.net/npm/prismjs@1/plugins/autoloader/prism-autoloader.min.js"}}]);function ae(m,r,o){let t,s,e;function i(){if(!s)return;let a;for(const l of s){if(l.el.getBoundingClientRect().top>100)break;a=l}o(2,e=a||s[0])}O(async()=>{o(1,s=Array.from(t.querySelectorAll("h1,h2,h3,h4,h5,h6"),a=>({el:a,id:a.id,title:a.textContent,depth:+a.tagName.toLowerCase().slice(1)}))),i(),await ee,window.Prism.highlightAllUnder(t)});function n(a){K[a?"unshift":"push"](()=>{t=a,o(0,t)})}return[t,s,e,i,n]}class re extends U{constructor(r){super();N(this,r,ae,Z,E,{})}}export{re as default};
